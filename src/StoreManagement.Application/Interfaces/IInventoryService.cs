...
public interface IInventoryService
{
    ...
    Task<IReadOnlyCollection<StockAdjustmentResponse>> GetAdjustmentsAsync(CancellationToken cancellationToken);
    Task<StockAdjustmentResponse> CreateAdjustmentAsync(CreateStockAdjustmentRequest request, string createdBy, string? clientRequestId, CancellationToken cancellationToken);
    ...
    Task<IReadOnlyCollection<InventoryReconciliationResponse>> ReconcileAsync(CancellationToken cancellationToken);
    Task<IReadOnlyCollection<PurchaseSuggestionResponse>> GetPurchaseSuggestionsAsync(CancellationToken cancellationToken);
}
